...
class SensorTemperatura:
    ...
    def em_alerta(self):
        ...
        print(f"Alerta: {'LIGADO' if alerta else 'DESLIGADO'}\n")
        return alerta


class TestSensorTemperatura(unittest.TestCase):
    #Uso de @patch('random.uniform', return_value=...) para simular os valores fixos para testar o código
    ...
    def test_temperatura_normal(self, mock_random):
        ...
        print(f"Temperatura simulada: {temp:.2f}°C")
